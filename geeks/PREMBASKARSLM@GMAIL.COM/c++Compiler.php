...
$query = "SELECT Geek_Level FROM geek where Geek_Email='".$_SESSION['progeeks_uid']."' ";
...
if($error==''){
	...
	$in1="";
	$in2="";
	echo(shell_exec("timeout --signal=SIGKILL 1 ./a.out < ".$infile." >".$outfile));
